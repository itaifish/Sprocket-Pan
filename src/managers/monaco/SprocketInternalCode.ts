...
import okvpText from '@/classes/OrderedKeyValuePairs?raw';
import utilsText from '@/types/utils/utils?raw';
import stateText from '@/types/state/state?raw';
...
const standalone = [okvpText, utilsText, stateText, auditText];
